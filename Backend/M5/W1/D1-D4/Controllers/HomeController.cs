        ...
        public IActionResult SendEmail(EmailViewModel model)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    string predefinitoOggetto = "Oggetto Predefinito";
                    string predefinitoMessaggio = "Questo è un messaggio predefinito.";
                    ...
                    using (var client = new SmtpClient(smtpServer, smtpPort))
                    {
                        ...
                        var mailMessage = new MailMessage
                        {
                            ...
                            Subject = predefinitoOggetto,
                            Body = predefinitoMessaggio,
                            IsBodyHtml = true
                        };
                    ...
                    TempData["Success"] = "Email inviata con successo!";
                    return RedirectToAction("Index");
                }
                catch (Exception ex)
                {
                    TempData["Error"] = "Si è verificato un errore durante l'invio dell'email. Riprova più tardi.";
